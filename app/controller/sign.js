...
class SignController extends Controller {
  async showLogin() {
    ...
    let data = { pageTitle: '登录' };
    await ctx.render('/sign/signin', data);
  }
  ...
  async showSignup() {
    ...
    let data = { pageTitle: '注册' };
    await ctx.render('/sign/signup', data);
  }
  ...
  async activeAccount() {
    ...
    let data = { success: '帐号已被激活，请登录' };
    await ctx.render('notify/notify', data);
  }
  ...
  async updateSearchPass() {
    ...
    await this.ctx.render('notify/notify', data);
  }
  ...
  async resetPass() {
    ...
    let data = { name, key };
    await this.ctx.render('sign/reset', data);
  }
